...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
        ...
        array(
            'id'       => 'wsb_field_custom_theme',
            'type'     => 'text',
            'title'    => __( 'Custom theme', 'wsbintegration' ),
            'desc'     => __( 'Enter the name of your theme', 'wsbintegration' ),
            'required' => array( 'wsb_field_theme', 'equals', 'custom' )
        ),
        array(
            'id'      => 'wsb_field_event_page',
            'type'    => 'select',
            'data'    => 'pages',
            'title'   => __( 'Event Page', 'wsbintegration' ),
            'desc'    => __( 'Select a page to show a detailed info about event. This page must contain [wsb_event_details] shortcode.', 'wsbintegration' ),
        ),
        array(
            'id'      => 'wsb_field_trainer_page',
            'type'    => 'select',
            'data'    => 'pages',
            'title'   => __( 'Trainer Profile', 'wsbintegration' ),
            'desc'    => __( 'Select a page to show a detailed trainer profile. This page must contain [wsb_trainer_details] shortcode.', 'wsbintegration' ),
        ),
    )
) );

Redux::setSection( $opt_name, array(
    'title'            => __( 'Event List', 'wsbintegration' ),
    'id'               => 'wsb_event_list_section',
    'customizer_width' => '400px',
    'icon'             => 'el el-list-alt',
    'fields'           => array(
        array(
            'id'       => 'wsb_field_no_events',
            'type'     => 'text',
            'title'    => __( 'Customize the text when no events to show', 'wsbintegration' ),
            'default'  => __( 'No events found', 'wsbintegration')
        ),
        array(
            'id'      => 'wsb_field_event_list_type',
            'type'     => 'radio',
            'title'    => __( 'Layout', 'wsbintegration' ),
            'desc'     => __( 'This field defines how the list of events is presented', 'wsbintegration' ),
            'options'  => array(
                'table' => 'Table',
                'tile' => 'Tiles',
            ),
