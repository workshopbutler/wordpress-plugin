<?php
/**
 * The Template for displaying calendar table
 *
 * This template can be overridden by copying it to yourtheme/workshop-butler/calendar-table.php.
 *
 * @version 3.0.0
	...
	<div class="wsb-content">
		...
		<div class="wsb-schedule">
			<div class="wsb-table" data-event-list>
				<?php do_action( 'wsb_before_schedule' ); ?>
